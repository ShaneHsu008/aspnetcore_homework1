...
namespace aspnetcore_homework.Migrations
{
    ...
    [Migration("20191213042740_02_AddDateModified")]
    partial class _02_AddDateModified
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Course", b =>
                {
                    b.HasOne("aspnetcore_homework.Models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.CourseInstructor", b =>
                {
                    b.HasOne("aspnetcore_homework.Models.Course", "Course")
                    ...
                    b.HasOne("aspnetcore_homework.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("aspnetcore_homework.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("aspnetcore_homework.Models.OfficeAssignment", b =>
                {
                    b.HasOne("aspnetcore_homework.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("aspnetcore_homework.Models.OfficeAssignment", "InstructorId")
